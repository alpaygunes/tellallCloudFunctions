...
let LoginPage = class LoginPage {
    constructor(authService, appVersion, loadingController, router, location, route, platform) {
    ...
    login() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.authService.login(this.email, this.password, this.returnURL).then(function (firebaseUser) {
                this.router.navigate(BU.returnURL).then(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
