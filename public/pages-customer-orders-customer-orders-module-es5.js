(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-customer-orders-customer-orders-module"], {
    ...
    /***/
    function typ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_customer_orders_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./customer-orders.page.html */
      "OtvC");
      /* harmony import */


      var _customer_orders_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var src_app_objects_cart_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/objects/cart.model */
      "uYlw");

      var CustomerOrdersPage = /*#__PURE__*/function () {
        function CustomerOrdersPage(location, route, orderService, router) {
          var _this = this;
        ...
        _createClass(CustomerOrdersPage, [{
          ...
          value: function getCutomerOrders() {
            var _this2 = this;

            var orders_ref = this.orderService.getCutomerOrders(this.cid);
            orders_ref.orderBy('created_at', 'desc');
            orders_ref.where('uid', '==', this.uid);
            orders_ref.limit(this.limit);
            orders_ref.get().then(function (customer_orders) {
              _this2.customerOrders = customer_orders.docs.map(function (order) {
          ...
          value: function cancelOrder(order) {
            this.orderService.cancelOrder(this.cid, order).then(function () {
      ...
      CustomerOrdersPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function OX5x(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function OtvC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Uix4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function yvKD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=pages-customer-orders-customer-orders-module-es5.js.map