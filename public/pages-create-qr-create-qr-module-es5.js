(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-create-qr-create-qr-module"], {
    /***/
    "0FX9":
    /*!********************************************!*\
    ...
    "JYoN":
    /*!*************************************************************!*\
      !*** ./src/app/pages/create-qr/create-qr-routing.module.ts ***!
      \*************************************************************/

    /*! exports provided: CreateQrPageRoutingModule */

    /***/
    function JYoN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CreateQrPageRoutingModule", function () {
        return CreateQrPageRoutingModule;
      });
      /* harmony import */
      ...
      var _create_qr_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./create-qr.page */
      "R3c4");

      var routes = [{
        path: '',
        component: _create_qr_page__WEBPACK_IMPORTED_MODULE_3__["CreateQrPage"]
      }];

      var CreateQrPageRoutingModule = function CreateQrPageRoutingModule() {
        _classCallCheck(this, CreateQrPageRoutingModule);
      };

      CreateQrPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    "R3c4":
    /*!***************************************************!*\
      !*** ./src/app/pages/create-qr/create-qr.page.ts ***!
      \***************************************************/

    /*! exports provided: CreateQrPage */

    /***/
    function R3c4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CreateQrPage", function () {
        return CreateQrPage;
      });
      /* harmony import */
      ...
      var _raw_loader_create_qr_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./create-qr.page.html */
      "RV5d");
      /* harmony import */


      var _create_qr_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./create-qr.page.scss */
      "c+BA");
      /* harmony import */
      ...
      var src_app_services_channel_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/services/channel.service */
      "0xJi");
      /* harmony import */


      var src_app_services_message_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var CreateQrPage = /*#__PURE__*/function () {
        function CreateQrPage(route, platform, socialSharing, location, router, toastController, loadingController, channelService, messageService, rootURL, ngxQRCodeModule) {
          _classCallCheck(this, CreateQrPage);
          ...
          this.channelUrl = 'Techiediaries';
          this.channel_is_flash = false;
          this.show_share_icons = true;
        }

        _createClass(CreateQrPage, [{
          key: "ngOnInit",
                  ...
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      this.channelService.getChannelInfo(this.channel_id).ref.get().then(function (snapshot) {
                        loading.dismiss();
                        _this.channel = snapshot.data();
                        _this.channel.id = _this.channel_id;
                        _this.channel_is_flash = _this.channel.flash;

                        if (_this.channel.flash) {
          ...
          value: function getAllMessages() {
            ...
            this.messageService.getAllMessages(this.channel.id).ref.get().then(function (snapshot) {
              _this2.messages = snapshot.docs.map(function (c) {
                var b = c.data();
                b.id = c.id;
                return b;
              });
          ...
          key: "shareWhatsapp",
          value: function shareWhatsapp(url, message) {
            debugger;
            var text = message ? message.text : this.channel.channel_name + this.channel.description;
            this.socialSharing.shareViaWhatsApp(text, null, url).then(function (res) {
              console.log(res);
            })["catch"](function (e) {
              console.log(e);
            });
          ...
          key: "shareInstagram",
          value: function shareInstagram(url, message) {
            debugger;
            var text = message ? message.text : this.channel.channel_name + this.channel.description;
            var image = "";
            this.socialSharing.shareViaInstagram(text, image).then(function (res) {
              console.log(res);
            })["catch"](function (e) {
              console.log(e);
            });
          ...
          key: "shareFacebook",
          value: function shareFacebook(url, message) {
            debugger;
            var text = message ? message.text : this.channel.channel_name + this.channel.description;
            var image = "";
            this.socialSharing.shareViaFacebook(text, image, url).then(function (res) {
              console.log(res);
            })["catch"](function (e) {
              console.log(e);
            });
      ...
      CreateQrPage.ctorParameters = function () {
        return [{
          ...
          type: _techiediaries_ngx_qrcode__WEBPACK_IMPORTED_MODULE_5__["NgxQRCodeModule"]
        }];
      };

      CreateQrPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-create-qr',
        template: _raw_loader_create_qr_page_html__WEBPACK_IMPORTED_MODULE_1__["default"],
        styles: [_create_qr_page_scss__WEBPACK_IMPORTED_MODULE_2__["default"]]
      })], CreateQrPage);
      /***/
    },
    ...
    "RV5d":
    /*!*******************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/create-qr/create-qr.page.html ***!
      \*******************************************************************************************/

    /*! exports provided: default */

    /***/
    function RV5d(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<ion-toolbar> \n  <ion-tabs>\n    <ion-tab-bar slot=\"top\">  \n      <ion-button  fill=\"clear\" size=\"small\"  (click)=\"back()\" >\n        <ion-icon name=\"chevron-back-outline\" ></ion-icon>\n      </ion-button>\n      <ion-tab-button>\n        <ion-menu-button></ion-menu-button>\n      </ion-tab-button>\n      <ion-tab-button (click)=\"router.navigate(['home'])\"> \n        <ion-icon name=\"home\"></ion-icon> \n      </ion-tab-button> \n    </ion-tab-bar>    \n  </ion-tabs>\n</ion-toolbar>  \n\n\n<ion-content>\n  <!-- ----------------------------- kanal QR ve link  paylaşımı -->\n  <ion-card class=\"qr-cart\" *ngIf=\"!channel_is_flash\">\n    <ngx-qrcode \n      [elementType] =\"elementType\" \n      [value]       =\"rootURL +'?c='+ channel_id\"\n      cssClass      =\"aclass\"\n      width         =200\n      errorCorrectionLevel=\"L\">\n    </ngx-qrcode>\n    <ion-card-header>\n      <ion-card-subtitle>Kanalınızın QRkodunu yazdırarak paylaşabilirsiniz</ion-card-subtitle> \n    </ion-card-header>\n    <ion-card-content>\n      <ion-item lines=\"full\">\n        <ion-icon  name=\"logo-whatsapp\" *ngIf=\"show_share_icons\" (click)=\"shareWhatsapp(this.rootURL +'?c='+ this.channel_id)\"  class=\"social-btn\"></ion-icon>\n        <ion-icon  name=\"logo-facebook\" *ngIf=\"show_share_icons\" (click)=\"shareFacebook(this.rootURL +'?c='+ this.channel_id)\"  class=\"social-btn\"></ion-icon>\n        <ion-icon  name=\"logo-instagram\" *ngIf=\"show_share_icons\" (click)=\"shareInstagram(this.rootURL +'?c='+ this.channel_id)\" class=\"social-btn\"></ion-icon>\n        <ion-icon  name=\"copy-outline\"   (click)=\"copyToClipBoard(this.rootURL +'?c='+ this.channel_id)\"    class=\"social-btn\"></ion-icon>\n      </ion-item>\n    </ion-card-content>\n  </ion-card>\n\n  <!-- ---------------------  eğer içerik flash mesaj ise RQ ve link      -->\n  <div *ngIf=\"channel_is_flash\">\n\n    <ion-grid fixed>\n      <ion-row>\n        <ion-col size=\"12\" style=\"text-align: center;\"> \n          <ion-icon name=\"alert-circle-outline\" style=\"font-size: 44px;\"></ion-icon>\n        </ion-col>\n      </ion-row>\n      <ion-row>\n        <ion-col size=\"12\"> \n          <ion-label color=\"medium\" style=\"text-align: center;display: block;\"> \n            Flash mesajlar ayrı QRkodları ile paylaşılır.\n          </ion-label> \n        </ion-col>\n      </ion-row>\n      <ion-row>\n        <ion-col>\n          <ion-label color=\"medium\" style=\"text-align: center;display: block;\"> \n            Flash kanalların QRkodları ve abonelik işlevi olmaz. \n          </ion-label> \n        </ion-col> \n      </ion-row> \n      <ion-row>\n        <ion-col>\n          <ion-label color=\"dark\" style=\"text-align: center;display: block;\"> \n            İçerikleriniz QRkodunu yazdırarak paylaşabilirsiniz \n          </ion-label> \n        </ion-col> \n      </ion-row> \n    </ion-grid>\n\n    <ion-card class=\"qr-cart\" *ngFor=\"let message of messages; let i = index\"> \n      <ion-card-subtitle>#{{i+1}}</ion-card-subtitle>\n        <ngx-qrcode  \n          [elementType] =\"elementType\" \n          [value]       =\"rootURL +'?c='+ channel_id + '&m=' + message.id\"\n          cssClass      =\"aclass\"\n          width         =200\n          errorCorrectionLevel=\"L\">\n        </ngx-qrcode>\n\n      <ion-card-content> \n        <ion-item *ngIf=\"message.type == 'food_drink_menu'\" lines=\"none\">\n          <ion-label>{{message.food_drink_menu.title}}</ion-label>\n        </ion-item>\n        <ion-item *ngIf=\"message.type == 'brochure'\" lines=\"none\">\n          <ion-label>{{message.brochure.title}}</ion-label>\n        </ion-item>\n        <ion-item *ngIf=\"message.type == 'text'\" lines=\"none\">\n          <ion-label class=\"ion-text-wrap\" style=\"text-align: center;\">{{message.text}}</ion-label>\n        </ion-item> \n      </ion-card-content>\n      <ion-card-content>\n        <ion-item    lines=\"full\">\n          <ion-icon  name=\"logo-whatsapp\" *ngIf=\"show_share_icons\"   (click)=\"shareWhatsapp(message)\"   class=\"social-btn\"></ion-icon>\n          <ion-icon  name=\"logo-facebook\" *ngIf=\"show_share_icons\"  (click)=\"shareFacebook(message)\"   class=\"social-btn\"></ion-icon>\n          <ion-icon  name=\"logo-instagram\" *ngIf=\"show_share_icons\" (click)=\"shareInstagram(message)\"  class=\"social-btn\"></ion-icon>\n          <ion-icon  name=\"copy-outline\"    (click)=\"copyToClipBoard(rootURL +'?c='+ channel_id + '&m=' + message.id)\" class=\"social-btn\"></ion-icon>\n        </ion-item>\n      </ion-card-content>\n    </ion-card>\n  </div>\n</ion-content>\n";
      /***/
    },
    ...
    "c+BA":
    /*!*****************************************************!*\
      !*** ./src/app/pages/create-qr/create-qr.page.scss ***!
      \*****************************************************/

    /*! exports provided: default */

    /***/
    function cBA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = ".qr-cart {\n  box-shadow: none;\n  text-align: center;\n  position: relative;\n  margin-top: 20%;\n}\n\n.qr-cart .aclass img {\n  max-width: unset !important;\n  width: 500px !important;\n}\n\n.social-btn {\n  margin-right: auto;\n  margin-left: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    /*! exports provided: NgxQRCodeModule, NgxQrcodeElementTypes, NgxQrcodeErrorCorrectionLevels, QrcodeComponent */

    /***/
    function hiuq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NgxQRCodeModule", function () {
        return NgxQRCodeModule;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "NgxQrcodeElementTypes", function () {
        return NgxQrcodeElementTypes;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "NgxQrcodeErrorCorrectionLevels", function () {
      ...
      var QrcodeComponent = /*#__PURE__*/function () {
        ...
        _createClass(QrcodeComponent, [{
            ...
            switch (this.elementType) {
              case NgxQrcodeElementTypes.CANVAS:
                ...
                this.toCanvas(element).then(function () {
                  _this3.renderElement(element);
                })["catch"](function (e) {
                  _this3.removeElementChildren();
              ...
              default:
                ...
                this.toDataURL().then(function (src) {
                  ...
                  if (_this3.alt) {
                    element.setAttribute('alt', _this3.alt);
                  }
          ...
          value: function toDataURL() {
            return qrcode__WEBPACK_IMPORTED_MODULE_2___default.a.toDataURL(this.value, {
          ...
          value: function toCanvas(canvas) {
            return qrcode__WEBPACK_IMPORTED_MODULE_2___default.a.toCanvas(canvas, this.value, {
              version: this.version,
              errorCorrectionLevel: this.errorCorrectionLevel,
              margin: this.margin,
              scale: this.scale,
      ...
      Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], QrcodeComponent.prototype, "value", void 0);
      ...
      Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('qrcElement')], QrcodeComponent.prototype, "qrcElement", void 0);

      var NgxQRCodeModule = function NgxQRCodeModule() {
        _classCallCheck(this, NgxQRCodeModule);
      };

      NgxQRCodeModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
        type: NgxQRCodeModule
      });
      NgxQRCodeModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        factory: function NgxQRCodeModule_Factory(t) {
    ...
    "iy5y":
    /*!*****************************************************!*\
      !*** ./src/app/pages/create-qr/create-qr.module.ts ***!
      \*****************************************************/

    /*! exports provided: CreateQrPageModule */

    /***/
    function iy5y(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CreateQrPageModule", function () {
        return CreateQrPageModule;
      });
      /* harmony import */
      ...
      var _create_qr_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./create-qr-routing.module */
      "JYoN");
      /* harmony import */


      var _create_qr_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./create-qr.page */
      "R3c4");
      /* harmony import */
      ...
      var CreateQrPageModule = function CreateQrPageModule() {
        _classCallCheck(this, CreateQrPageModule);
      };

      CreateQrPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_techiediaries_ngx_qrcode__WEBPACK_IMPORTED_MODULE_7__["NgxQRCodeModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _create_qr_routing_module__WEBPACK_IMPORTED_MODULE_5__["CreateQrPageRoutingModule"]],
        declarations: [_create_qr_page__WEBPACK_IMPORTED_MODULE_6__["CreateQrPage"]]
      })], CreateQrPageModule);
      /***/
    },
    ...
    function yKow(module, exports, __webpack_require__) {
      ...
      var isArray = __webpack_require__(
      /*! isarray */
      "49sm"); // Generator polynomial used to encode version information
...
//# sourceMappingURL=pages-create-qr-create-qr-module-es5.js.map